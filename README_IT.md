...
La mappa coropletica mostra la densità di società sulla piattaforma in tutte le 107 province italiane (verde = maggiore presenza, rosso = minore). La copertura è concentrata nel nord e nel centro Italia, con le regioni del sud e le isole che mostrano una presenza comparativamente più bassa.
